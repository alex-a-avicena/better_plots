...
class Colormaps():
    ...
    def __init__(self):
        ...
        self.sunflower_rgb = ["#EFCC00", "#F5AB29", "#E09D26", "#C98540", "#A75D58", "#A82F63", "#812359", "#632247", "#52203D", "#521B18", "#341B18", "#000000"]
        self.brown_teal_rgb = ["#543005", "#8D5109", "#C0822D", "#E1C37D", "#F8E9C4", "#C8EBE6", "#80CEC2", "#359890", "#01665E", "#003C30"]
        self.orange_purple_rgb = ["#7F3B07", "#B45806", "#E18313", "#FEB963", "#FFE1B7", "#D9DBED", "#B3ACD3", "#8073AD", "#542789", "#2D004B"]
        self.red_blue_rgb = ["#67001F", "#B3172B", "#D7604D", "#F5A683", "#FEDCC8", "#D2E6F1", "#93C6E0", "#4394C4", "#2166AD", "#053061"]
        ...
        self.fire = LinearSegmentedColormap.from_list("fire", self.fire_rgb, N=256) 
        self.grayblue = LinearSegmentedColormap.from_list("grayblue", self.grayblue_rgb, N=256)
        self.yellow_green = LinearSegmentedColormap.from_list("yellow-green", self.yellow_green_rgb, N=256)
        self.sunflower = LinearSegmentedColormap.from_list("sunflower", self.sunflower_rgb, N=256)
        self.brown_teal = LinearSegmentedColormap.from_list("div-brown-teal", self.brown_teal_rgb, N=256)
        self.orange_purple = LinearSegmentedColormap.from_list("div-orange-purple", self.orange_purple_rgb, N=256)
        self.red_blue = LinearSegmentedColormap.from_list("div-red-blue", self.red_blue_rgb, N=256)
        self.magma = colormaps["magma"]
        self.plasma = colormaps["plasma"]
        self.inferno = colormaps["inferno"]
        self.viridis = colormaps["viridis"]
        self.hsv = colormaps["hsv"]
        ...
        self.maps = {
                        ...
                        "diverging-brown-teal":self.brown_teal,
                        "diverging-orange-purple":self.orange_purple,
                        "diverging-red-blue":self.red_blue,
                        "hsv":self.hsv
                    }
